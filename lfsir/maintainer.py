...
def update_online_files(recreate=False, replace=False) -> None:
    ...
    for directories in [
        (defaults.cleaned_data, "parquet_files"),
...
def publish_processed_table(
    table_name: _OriginalTable | Iterable[_OriginalTable] | Literal["all"] = "all",
    years: _Years = "last",
